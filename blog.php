...
<div class="rwo">
    ...
    <h2 class="titleblog">At The End Of The Day, Our Goals Are Simple : Safety and Security.</h2>
    <p class="contactorgpara ctorgpar">
        ...
        <br>
        <br>
        <h2 class="titleblog"> The ugly truth about fire accidents:<br></h2>
         <p class="contactorgpara ctorgpar">
    ...
    <br>
        ...
        <br>
            ...
            <h2 class="titleblog"> On the roads:</h2><br> <p class="contactorgpara ctorgpar">The need to commute comes with the ability to participate in economic opportunities. With poor infrastructure both in terms of quality and quantity, women are significantly disadvantaged here. We all know that India’s killer roads claim 400 lives every day. While the proportion of female victims is lower than males in a comparative sense today, this can change with increasing participation of women in the workforce. As the collaborative study by Transport Research and Injury Prevention Programme (TRIPP) and IIT Delhi in 2015 points out, 
...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
	...
	if ($result) {
		...
		echo "<script>alert('report does not add.')</script>";
	}
}

?>
<div class="wrapper container" style='align=center;'>
      <form action="" method="POST" class="form" align='center'>
          ...
          <div class="input-group textarea">
              ...
              <textarea id="comment" name="comment" placeholder="Put your comment here" required></textarea>
          </div>
          <div class="input-group">
              <button name="submit" class="btn" style="background-color:rgb(107, 72, 191);">Post your comment </button>
          </div>
      </form>
